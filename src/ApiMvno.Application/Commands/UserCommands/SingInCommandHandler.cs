...
public class SingInCommandHandler : IRequestHandler<SingInCommand, SingInResponseModel>
{
    ...
    public SingInCommandHandler(IMediator mediator, UserManager<User> userManager, SignInManager<User> signInManager,
    ...
    private const string LoginBlocked = "Login blocked.";
    private const string InvalidUseramePassword = "Invalid username or password.";
    private const string EmailNotConfirmed = "Unverified email, check your email and follow the instructions for email confirmation.";
    private const string UserDeactivated = "User deactivated.";
    ...
    public async Task<SingInResponseModel> Handle(SingInCommand request, CancellationToken cancellationToken)
    {
        ...
        return new SingInResponseModel()
        {
